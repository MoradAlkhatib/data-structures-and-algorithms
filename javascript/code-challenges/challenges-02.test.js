...
Write a function named addOne that, given an array of numbers, uses map to return a new array with each value
 simply incremented by 1. 
------------------------------------------------------------------------------------------------ */

const addOne = (arr) => {
  // Solution code here...
  let newArrr=arr.map(elem=>elem+1)
  return newArrr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArray=arr.map(elem=> Math.pow(2, elem))
  return newArray;
};
...
const charCode = (arr) => {
  // Solution code here...
  let newArray=arr.map(elem=> elem.charCodeAt(0))
...
Write a function that, given an array of numbers as input, uses map to return a new array
...
const extractStats = (arr) => {
  // Solution code here...
  let newArray=arr.map(elem=>{
    return {name:elem.stat.name,total:elem.effort+elem.baseStat};
  })
 return newArray;
