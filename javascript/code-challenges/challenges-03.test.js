...
const typeNum = (arr) => {
  // Solution code here...
  let newArray=arr.filter(elem=>typeof(elem)==='number')
  return newArray;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArray=arr.filter(elem=>elem.includes('and'))
  return newArray;
...
const oddValues = (arr) => {
  // Solution code here...
  let newArray=arr.filter(elem=>elem%2===1)
  return newArray;
};
...
Write a function named getBaseStatGreaterThan that, given the snorlaxData, below,
 and an integer as input, uses filter to return an array containing all stats with a baseStat greater
  than the integer.
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let newArray=arr.filter(elem=>elem.baseStat>minBaseStat)
  return newArray;
};
...
const getStatName = (arr, minBaseStat) => {
  ...
  let newArray =[];
   arr.forEach(elem => {
     if(elem.baseStat > minBaseStat) newArray.push(elem.stat.name) 
  })
  return newArray;
