...
Write a function named `addExclamation` that takes an array of strings, and returns a new array of the same strings with an
 "!" added to the end.
...
const fizzbuzz = (arr) => {
  ...
  let newArray=[];
  arr.forEach(elem=>{
    if(elem%3===0 && elem%5===0){newArray.push("Fizz Buzz");}
    else if(elem%5===0){newArray.push("Buzz");}
    else if(elem%3===0 ){newArray.push("Fizz");}
